  ...
  return (
    <>
        ...
        <div className="flex w-full justify-center pt-10">
            <div className="flex flex-col items-center py-6 w-[75vh] cursor-default shadow-lg rounded-md bg-blue-50 gap-10 justify-center p-5">
                ...
                de la synthèse vocale naturelle et de la mesure du temps de lecture pour offrir une expérience utilisateur unique. Son principal objectif est de simplifier la conversion d'images
                 en texte, la traduction de ce texte vers différentes langues, et la restitution vocale fluide. <br/><br/>
